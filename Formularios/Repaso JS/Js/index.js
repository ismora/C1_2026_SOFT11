...
function validarCamposVacios(){
    let error = false;  //iniciamos por defecto en false asumiendo que no hay errores
...
/*function CelsiusFahrenheit(F){
    C=(F-32)/1.8
    console.log("El valor: " +F+ " convertido a Fahrenheit es igual a: " +C);
}

CelsiusFahrenheit(32); */
